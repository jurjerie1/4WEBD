                                    ...
                                    <div key={event.id} className="bg-white shadow rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="mt-6 flex items-center justify-between">
                                                <div>
                                                    <span className="text-2xl font-bold text-gray-900">{new Date(event.date).toLocaleDateString()}</span>
                                                    <span className="block text-sm text-gray-500">à {new Date(event.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                                                </div>
                                                <button
